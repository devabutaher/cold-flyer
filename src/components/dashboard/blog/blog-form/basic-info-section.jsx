...
const CATEGORIES = ["Maintenance", "Buying Guide", "Smart Home", "Tips", "News"];
      ...
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <CardDescription className="text-xs mt-0.5">Core blog post details</CardDescription>
          </div>
        </div>
      </CardHeader>
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                <Input
                  {...field}
                  placeholder="e.g. Pre-Summer AC Checklist"
                  value={field.value ?? ""}
            ...
            render={({ field }) => (
              <Field>
                ...
                <Input
                  ...
                  value={field.value ?? ""}
                  onChange={(e) => field.onChange(e.target.value)}
                  placeholder="e.g. AC, summer, maintenance"
                />
              </Field>
            )}
          />
