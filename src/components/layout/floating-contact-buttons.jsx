...
const WHATSAPP_NUMBER = "8809612345678";
const WHATSAPP_MESSAGE =
  "Hi, I'd like to know more about Cold Flyer's products and services.";
          ...
          <Tooltip key={btn.key}>
            <TooltipTrigger asChild>
              <motion.a
                ...
                initial={
                  shouldReduceMotion ? undefined : { opacity: 0, scale: 0.5 }
                }
                animate={
                  shouldReduceMotion
                    ? { opacity: 1, scale: 1 }
